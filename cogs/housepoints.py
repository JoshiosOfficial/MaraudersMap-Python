    ...
    async def housepoints(self, ctx):
        ...
        embed = discord.Embed(
            description = (
                ...
                f"{self.client.emotes[housepoints[0][0].upper()]} {housepoints[0][0].capitalize()} is **{housepoints[0][1] - housepoints[1][1]}** points ahead of {self.client.house_emojis[housepoints[1][0]]} {housepoints[1][0].capitalize()}!"
            ),
